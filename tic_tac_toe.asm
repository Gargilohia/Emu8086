...
CREATEDBY DB 'Made by Pallavi, Gargi and Sharat$' 
...
C8 DB '8$'
C9 DB '9$'
; PLAYER NO. , MOVES AND CHECK FLAGS FOR IF THE GAME IS WON 
...
ERR DB 32, 32, 32, 'Wrong input! Press any key $' 
EMP DB ' $' 
.CODE
MAIN PROC
 MOV AX, @DATA
...
;DISPLAY THE TITLE SCREEN 
 ...
 LEA DX, CREATEDBY ; DEVELOPER NAME DISPLAY
 MOV AH, 9
 INT 21H
 ...
 LEA DX, Cont ; PRESS ANY KEY
 MOV AH, 9
 INT 21H
 
 MOV AH, 7 ; INPUT ERRTHOUT ECHO
 INT 21H
...
; DRAW 
 ...
 JMP TRYAGAIN 
; CHECK IF ERRNNING CONDITION IS MET 
 CHECK: ; THERE ARE 8 POSSIBLE ERRNNING COMBINATIONS 
...
INPUT:
 ...
 LEA DX, ERR ; WRONG INPUT MESSAGE
 MOV AH, 9
 INT 21H
